// Mapeamento de area codes (DDD) dos EUA pro estado (USPS abbreviation).
// Fonte: NANPA / área metropolitana. Cobre todos os area codes validos em uso.
// Quando um area code cobre mais de um estado, usa o primario/dominante.
...
export const AREA_CODE_TO_STATE: Record<string, string> = {
  ...
  // California
  '209': 'CA', '213': 'CA', '279': 'CA', '310': 'CA', '323': 'CA', '341': 'CA', '350': 'CA',
  '369': 'CA', '408': 'CA', '415': 'CA', '424': 'CA', '442': 'CA', '510': 'CA', '530': 'CA',
  '559': 'CA', '562': 'CA', '619': 'CA', '626': 'CA', '628': 'CA', '650': 'CA', '657': 'CA',
  '661': 'CA', '669': 'CA', '707': 'CA', '714': 'CA', '747': 'CA', '760': 'CA', '805': 'CA',
  '818': 'CA', '820': 'CA', '831': 'CA', '837': 'CA', '840': 'CA', '858': 'CA', '909': 'CA',
  '916': 'CA', '925': 'CA', '935': 'CA', '949': 'CA', '951': 'CA',
  // Colorado
  ...
  '202': 'DC', '771': 'DC',
  // Florida
  '239': 'FL', '305': 'FL', '321': 'FL', '324': 'FL', '352': 'FL', '386': 'FL', '407': 'FL',
  '448': 'FL', '561': 'FL', '645': 'FL', '656': 'FL', '689': 'FL', '727': 'FL', '728': 'FL',
  ...
  // Missouri
  '235': 'MO', '314': 'MO', '417': 'MO', '557': 'MO', '573': 'MO', '636': 'MO', '660': 'MO',
  '816': 'MO', '975': 'MO',
  // Montana
  '406': 'MT',
  // Nebraska
  ...
  '505': 'NM', '575': 'NM',
  // New York
  '212': 'NY', '315': 'NY', '329': 'NY', '332': 'NY', '347': 'NY', '363': 'NY', '516': 'NY',
  '518': 'NY', '585': 'NY', '607': 'NY', '624': 'NY', '631': 'NY', '646': 'NY', '680': 'NY',
  ...
  '419': 'OH', '436': 'OH', '440': 'OH', '513': 'OH', '567': 'OH', '614': 'OH', '740': 'OH', '937': 'OH',
  // Oklahoma
  ...
  '802': 'VT',
  // Virginia
  '276': 'VA', '434': 'VA', '540': 'VA', '571': 'VA', '686': 'VA', '703': 'VA', '757': 'VA',
...
/**
 * Extrai o estado (ex: "FL", "NY") de um numero de telefone US.
 * Retorna null se nao for possivel identificar (numero nao-US ou area code invalido).
 */
export function stateFromPhone(phone: string | null | undefined): string | null {
  ...
  if (digits.length === 11 && digits.startsWith('1')) {
    ...
    return null // numero nao-US (ex: Brasil 55...)
  }
