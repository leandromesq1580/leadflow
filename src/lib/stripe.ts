...
export const PRODUCTS = {
  lead: {
    name: 'Lead Exclusivo',
    packages: [
      // Starter — entrada baixa pra reduzir barreira ($99). Sem desconto: $19.80/lead.
      // Objetivo: agente novo testar o sistema com o equivalente a 1 apolice fechada.
      { id: 'lead_5', quantity: 5, unitPriceCents: 1980, totalDisplay: 99, label: 'Starter — 5 Leads $99', pricePerUnit: 19.80 },
  ...
  appointment: {
    ...
    packages: [
      { id: 'appt_10', quantity: 10, unitPriceCents: 4970, totalDisplay: 497, label: '10 Appointments — $497', pricePerUnit: 49.70 },
      { id: 'appt_25', quantity: 25, unitPriceCents: 4788, totalDisplay: 1197, label: '25 Appointments — $1,197', pricePerUnit: 47.88 },
    ],
  },
} as const
