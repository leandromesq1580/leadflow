...
export const messages = {
  pt: {
    ...
    hero: {
      ...
      titleA: 'Agente fechou 3 apólices no primeiro dia.',
      titleB: 'Você prefere esperar até amanhã?',
      tagline: 'Pare de correr atrás de contatos. Compre leads exclusivos prontos para follow-up.',
  ...
  en: {
    ...
    hero: {
      ...
      titleA: 'An agent closed 3 policies on day one.',
      titleB: 'Do you really want to wait until tomorrow?',
      tagline: 'Stop chasing contacts. Buy exclusive leads ready for follow-up.',
  ...
  es: {
    ...
    hero: {
      ...
      titleA: 'Un agente cerró 3 pólizas el primer día.',
      titleB: '¿Prefieres esperar hasta mañana?',
      tagline: 'Deja de perseguir contactos. Compra leads exclusivos listos para follow-up.',
