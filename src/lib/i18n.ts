...
export const messages = {
  pt: {
    ...
    hero: {
      ...
      titleA: 'Leads de seguro de vida gerados todo dia —',
      titleB: 'exclusivos, só seus',
      subtitle: 'A gente gera leads quentes nos EUA todos os dias e entrega com exclusividade total: cada lead é seu e de mais ninguém, nunca revendido. E ainda vem o CRM feito pro ramo pra distribuir pro time, acompanhar o pipeline e fechar mais apólices.',
  ...
  en: {
    ...
    hero: {
      ...
      titleA: 'Fresh life insurance leads every day —',
      titleB: 'exclusively yours',
      subtitle: "We generate hot leads across the US every single day and deliver them with full exclusivity: each lead is yours and no one else's, never resold. Plus the CRM built for the niche to auto-distribute to your team, track the pipeline, and close more policies.",
  ...
  es: {
    ...
    hero: {
      ...
      titleA: 'Leads de seguro de vida generados cada día —',
      titleB: 'exclusivos, solo tuyos',
      subtitle: 'Generamos leads calientes en EE.UU. todos los días y los entregamos con exclusividad total: cada lead es tuyo y de nadie más, nunca revendido. Y además el CRM hecho para el rubro para distribuir a tu equipo, seguir el pipeline y cerrar más pólizas.',
